...
export default function UpdateAdditionalSide({
  open,
  handleOpen,
  handleSubmit,
  formData,
    ...
    <Dialog open={open} handler={handleOpen}>
      <DialogHeader className="relative m-0 block">
        <Typography variant="h4" color="blue-gray">
          Update Additional Sides
        </Typography>
        <Typography className="mt-1 font-normal text-gray-600">
          Update a new Additional side item to your store.
        </Typography>
        <IconButton
          size="sm"
          variant="text"
      ...
      <DialogBody className="h-[20rem] overflow-y-scroll">
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              className={`!w-full !border-[1.5px] !border-blue-gray-200/90 bg-white text-gray-800 ring-4 ring-transparent focus:!border-primary ${
                errors.is_veg ? "border-red-500" : ""
              }`}
              placeholder="Select option"
              value={String(formData.is_veg)}
              size="lg"
              onChange={(value) => handleSelectChange("is_veg", value)}
              labelProps={{className: "hidden"}}>
              <Option value="true">Yes</Option>
              <Option value="false">No</Option>
            </Select>
