...
const TABLE_HEAD = ["Created", "Title", "Priority", "Status", "Action"];
...
export function Category() {
  ...
  const resetFormData = () => {
    setFormData({title: "", status: true, icon: "", priority: ""});
  };
            ...
            <table className="mt-4 w-full min-w-max table-auto text-left">
              ...
              <tbody
                ...
                {categoryData.length === 0 ? (
                  ...
                  categoryData.map(
                    ({created_at, category_name, status, id, icon, priority}, index) => {
